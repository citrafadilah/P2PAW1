...
localStorage.setItem("email", "jaemin@test.com");
// data array
let hobi = ["menyanyi", "dance", "akting"];
localStorage.setItem("hobi", hobi);
localStorage.setItem("myhobi", JSON.stringify(hobi));

// data object
let mhs = {npm: 2226240002, nama: "Taeyong"};
// cara akses
console.log(mhs.npm);
...
// tampilkan menggunakkan for atau forEach
